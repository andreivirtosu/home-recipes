...
<body>
  <header class="shell">
    ...
    <nav><a href="#library">Library</a><a href="#ingredients">Ingredients</a><a href="#add">Add recipe</a><a href="#features">Features</a></nav>
  </header>
